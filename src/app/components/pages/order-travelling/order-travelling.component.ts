...
@Component({
  selector: 'app-order-travelling',
  templateUrl: './order-travelling.component.html',
  styleUrls: ['./order-travelling.component.scss'],
})
export class OrderTravellingComponent implements OnInit {
  user: any;
  arrHeader = [
    ...
    { name: 'Fecha Approx De LLegada', key: 'estimatedDeliveryDateDisplay' },
